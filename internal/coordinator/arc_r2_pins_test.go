...
var r2Pin = map[string]map[string]string{
	// #1102's NAMING half: a bare star over a SET-OPERATION arm was left
	// unexpanded, so it published the JOIN OPERATOR's stream — the build
	// side's duplicate columns qualified by whichever relation the plan
	// built — where PostgreSQL publishes each arm's own list, duplicates kept
	// unqualified and by position. Arc O1 DECLINED this shape with the
	// measurement beside it, because a name the stream does not spell through
	// the block is not an address (`root-setop` in O1's census). On ALL FIVE
	// ARMS, which is what tells it apart from the value half below.
	"except-collide/both/star": {
		"single":       "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"spilled512k":  "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag":          "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag-shuffled": "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
	},
	"except-collide/left/star": {
		"single":       "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=2 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200",
		"spilled512k":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=2 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200",
		"dag":          "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=2 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200",
		"dag-shuffled": "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=2 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=2 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200",
	},
	"except-collide/right/star": {
		"single":       "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=2 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob",
		"spilled512k":  "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=2 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob",
		"dag":          "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob",
		"dag-shuffled": "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob",
	},
	"except/both/star": {
		"single":       "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"spilled512k":  "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag":          "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag-shuffled": "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag-morsel4":  "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
	},
	"intersect-collide/both/star": {
		"single":       "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"spilled512k":  "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag":          "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
		"dag-shuffled": "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=2 | 1,Alice,1,Alice | 2,Bob,2,Bob",
	...
	"union-all-collide/both/star": {
		"single":       "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"spilled512k":  "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag":          "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag-shuffled": "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
	},
	"union-all-collide/left/star": {
		"single":       "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=6 | 1,Alice,1,Alice,150 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0 | 3,Carol,3,Carol,0",
		"spilled512k":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=6 | 1,Alice,1,Alice,150 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0 | 3,Carol,3,Carol,0",
		"dag":          "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=6 | 1,Alice,1,Alice,150 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0 | 3,Carol,3,Carol,0",
		"dag-shuffled": "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=6 | 1,Alice,1,Alice,150 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0 | 3,Carol,3,Carol,0",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=6 | 1,Alice,1,Alice,150 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0 | 3,Carol,3,Carol,0",
	},
	"union-all-collide/right/star": {
		"single":       "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=6 | 1,Alice,150,1,Alice | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol | 3,Carol,0,3,Carol",
		"spilled512k":  "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=6 | 1,Alice,150,1,Alice | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol | 3,Carol,0,3,Carol",
		"dag":          "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=6 | 1,Alice,150,1,Alice | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol | 3,Carol,0,3,Carol",
		"dag-shuffled": "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=6 | 1,Alice,150,1,Alice | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol | 3,Carol,0,3,Carol",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=6 | 1,Alice,150,1,Alice | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol | 3,Carol,0,3,Carol",
	},
	"union-all/both/star": {
		"single":       "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"spilled512k":  "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag":          "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag-shuffled": "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
		"dag-morsel4":  "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=12 | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 1,Alice,1,Alice | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 2,Bob,2,Bob | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol | 3,Carol,3,Carol",
	},
	"union-collide/both/star": {
		"single":       "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"spilled512k":  "cols=[id:INT64 customer:STRING b.id:INT64 b.customer:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag":          "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag-shuffled": "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
	},
	"union-collide/left/star": {
		"single":       "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=3 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0",
		"spilled512k":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=3 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0",
		"dag":          "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=3 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0",
		"dag-shuffled": "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=3 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING o.id:INT64 o.customer:STRING total:FLOAT64] rows=3 | 1,Alice,1,Alice,150 | 2,Bob,2,Bob,200 | 3,Carol,3,Carol,0",
	},
	"union-collide/right/star": {
		"single":       "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=3 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol",
		"spilled512k":  "cols=[id:INT64 customer:STRING total:FLOAT64 a.id:INT64 a.customer:STRING] rows=3 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol",
		"dag":          "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol",
		"dag-shuffled": "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol",
		"dag-morsel4":  "cols=[id:INT64 customer:STRING total:FLOAT64 lat_ord.id:INT64 lat_ord.customer:STRING] rows=3 | 1,Alice,150,1,Alice | 2,Bob,200,2,Bob | 3,Carol,0,3,Carol",
	},
	"union/both/star": {
		"single":       "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"spilled512k":  "cols=[k:INT64 p:STRING b.k:INT64 b.p:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag":          "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag-shuffled": "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
		"dag-morsel4":  "cols=[k:INT64 p:STRING lat_ord.k:INT64 lat_ord.p:STRING] rows=3 | 1,Alice,1,Alice | 2,Bob,2,Bob | 3,Carol,3,Carol",
	},

	// #1102's VALUE half, on the three DAG arms: the set-operation arm's
	// columns reached the join under the SCAN's qualifier (`lat_ord.id`), so
	// `a.id` matched neither spelling exactly, fell through to the resolver's
	// qualifier strip, and bound the OTHER arm's bare `id`.
	"issue/1102": {
		"dag":          "cols=[id:INT64] rows=4 | 1 | 2 | 3 | 4",
		"dag-shuffled": "cols=[id:INT64] rows=4 | 1 | 2 | 3 | 4",
		"dag-morsel4":  "cols=[id:INT64] rows=4 | 1 | 2 | 3 | 4",
	},
	"issue/1102-all": {
		"dag":          "cols=[id:INT64] rows=8 | 1 | 1 | 2 | 2 | 3 | 3 | 4 | 4",
		"dag-shuffled": "cols=[id:INT64] rows=8 | 1 | 1 | 2 | 2 | 3 | 3 | 4 | 4",
		"dag-morsel4":  "cols=[id:INT64] rows=8 | 1 | 1 | 2 | 2 | 3 | 3 | 4 | 4",
	},
	"issue/1102-both-sides": {
		"dag":          "cols=[id:INT64 id:INT64] rows=4 | 1,1 | 2,2 | 3,3 | 4,4",
		"dag-shuffled": "cols=[id:INT64 id:INT64] rows=4 | 1,1 | 2,2 | 3,3 | 4,4",
		"dag-morsel4":  "cols=[id:INT64 id:INT64] rows=4 | 1,1 | 2,2 | 3,3 | 4,4",
	},
