...
func TestParseJoinKeys_PreservesQualifiers(t *testing.T) {
	left, right, _ := physical.ParseJoinKeys("n1.n_regionkey = r_regionkey")
	...
	// Compound:
	left, right, _ = physical.ParseJoinKeys("a.k1 = b.k1 AND a.k2 = b.k2")
	...
	left, right, _ = physical.ParseJoinKeys("s_suppkey = l_suppkey")
