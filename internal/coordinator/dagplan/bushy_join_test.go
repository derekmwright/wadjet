...
func planTree(t *testing.T, cat *catalog.Catalog, root *logical.Node) *physical.PhysicalPlan {
	t.Helper()
	ctx := context.Background()
...
func runPlanRows(t *testing.T, plan *physical.PhysicalPlan) []map[string]any {
	t.Helper()
