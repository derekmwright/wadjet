...
func refuseUnevaluableGroupKey(r physical.GroupKeyResolution, keys []string, i int, stageID string) error {
...
func resolveDerivedAliasKey(r physical.GroupKeyResolution, in []streamCol, arms map[string]bool,
