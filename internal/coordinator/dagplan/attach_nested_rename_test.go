...
func TestAttachScanSelectProjections_NestedRename(t *testing.T) {
	tests := []struct {
		name     string
		sql      string
		wantExpr string // physical.ProjectExprSpec.Expr on the producing stage
		wantName string // physical.ProjectExprSpec.Name on the producing stage
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			var spec *physical.ProjectExprSpec
