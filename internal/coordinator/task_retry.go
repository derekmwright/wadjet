...
// err supplies caller framing of the worker's raw error text.
// Panicked wins and means XX000 regardless of any prior class (ADR-0019).
// Otherwise preserve nonempty SQLState for ordinary runtime failures (#649).
// Empty SQLState leaves err unclassified; never invent a class.
// Neither field is inferred from free-form Error text: legitimate input can
// contain any substring, including an apparent internal-error marker.
// See docs/internals/worker-failure-sqlstate-transport.md for the design.
