...
// Never substitute their SQL text as a string literal: it silently changes filters
// and DML predicates (#710). compileWithCtx's unsupported-node default must FAIL,
// not guess a value; this is the same boundary as #610 for additional AST kinds.
// See docs/internals/row-and-quantified-compilation-boundary.md for the design.
