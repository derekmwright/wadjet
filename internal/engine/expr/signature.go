...
var textDomains = map[string][]ArgDomain{
	// to_regclass(text): PostgreSQL has no integer overload, so
	// `to_regclass(1)` is its 42883.
	"to_regclass": {ArgText},
	...
	"soundex":          {ArgText},
	"normalize":        {ArgText, ArgText},
	"overlay":          {ArgText, ArgText, ArgAny, ArgAny},
	"like_escape":      {ArgText, ArgText, ArgText},
	"similar_to":       {ArgText, ArgText, ArgText},
	"codepoint":        {ArgText},
...
var funcSignatures = map[string]Signature{
	// The pg_catalog functions a catalog query calls (pg_catalog_fns.go)
	// and the pattern-match operators' functions (pg_regex.go).
	"textregexeq":                     {Min: 2, Max: 2},
	"texticregexeq":                   {Min: 2, Max: 2},
	"textregexne":                     {Min: 2, Max: 2},
	"texticregexne":                   {Min: 2, Max: 2},
	"format_type":                     {Min: 2, Max: 2},
	"pg_get_userbyid":                 {Min: 1, Max: 1},
	"regclassout":                     {Min: 1, Max: 1},
	"regclassin":                      {Min: 1, Max: 1},
	"to_regclass":                     {Min: 1, Max: 1},
	"regrolein":                       {Min: 1, Max: 1},
	"regroleout":                      {Min: 1, Max: 1},
	"regtypein":                       {Min: 1, Max: 1},
	"regtypeout":                      {Min: 1, Max: 1},
	"regnamespacein":                  {Min: 1, Max: 1},
	"regnamespaceout":                 {Min: 1, Max: 1},
	"regprocout":                      {Min: 1, Max: 1},
	"pg_relation_is_publishable":      {Min: 1, Max: 1},
	"pg_get_serial_sequence":          {Min: 2, Max: 2},
	"pg_get_expr":                     {Min: 2, Max: 3},
	"pg_get_constraintdef":            {Min: 1, Max: 2},
	"pg_get_indexdef":                 {Min: 1, Max: 3},
	"pg_get_statisticsobjdef_columns": {Min: 1, Max: 1},
	"pg_get_function_result":          {Min: 1, Max: 1},
	"pg_get_function_arguments":       {Min: 1, Max: 1},
	"pg_get_triggerdef":               {Min: 1, Max: 2},
	"pg_get_ruledef":                  {Min: 1, Max: 2},
	"pg_get_viewdef":                  {Min: 1, Max: 2},
	"json_build_object":               {Min: 0, Max: 100},
	"array_upper":                     {Min: 2, Max: 2},
	"array_lower":                     {Min: 2, Max: 2},
	"abs":                             {Min: 1, Max: 1},
	"acos":                            {Min: 1, Max: 1},
	...
	"normalize":                       {Min: 1, Max: 2},
	"now":                             {Min: 0, Max: 0},
	"localtimestamp":                  {Min: 0, Max: 0},
	"overlay":                         {Min: 3, Max: 4},
	"like_escape":                     {Min: 3, Max: 3},
	"similar_to":                      {Min: 2, Max: 3},
	"nullif":                          {Min: 2, Max: 2},
