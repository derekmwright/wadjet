...
// durableWaitPollMin starts the doubling re-poll ramp at 25ms, capped at 500ms.
// Entering the wait publishes SubjectUploadRelease for an already-finalized
// local copy, making queued/foreground-yielded upload work urgent.
// Keep the same 15s budget and MissingInputKey failure semantics; the wait
// may overshoot by at most one interval.
// See docs/benchmarks/sf100-window2-analysis-2026-08-22.md §7.1.
// See docs/internals/worker-durable-upload-wait-ramp.md for the design.
