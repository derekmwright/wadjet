...
// with optional positional fallback (#471, #464).
// Populate ordered only from a RESULT declaration aligned with result columns:
// coordinator OutputSchema or result metas can preserve renamed output slots.
// Catalog-by-name guesses have no output-position relationship and must leave
// ordered nil; attaching a random catalog column would misorder ROW fields.
// See docs/internals/pgwire-nested-output-schema-order.md for the design.
