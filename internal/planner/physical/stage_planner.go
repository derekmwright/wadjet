...
// them. It embeds the local Planner because stage emission reads the same
...
// of Planner, which meant the embedded engine carried the stage emitter's
...
func NewStagePlanner(p *Planner) *StagePlanner {
