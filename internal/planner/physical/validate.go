...
// resolveRef accepts resolved or uncertain references; proven misses return
// 42703 (column), 42P01 (qualifier, #380), or 42702 (bare ambiguity, #367).
// refuseDelimitedMiss enforces byte-exact delimited column names (#731);
// unquoted names are already folded by the lexer.
// Refuse only where colTypes establishes a base-table declaration and exact
