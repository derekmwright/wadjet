...
// CoerceBooleanLiterals resolves UNKNOWN literals in truth contexts at parse
// time (#599); invalid boolean text is 22P02, not typed-nonboolean 42804.
// NULL remains NULL. Match CAST's PostgreSQL boolean grammar (ADR-0012):
// case-insensitive nonempty true/false/yes/no prefixes, unambiguous on/off
// prefixes and single 1/0, trimming C whitespace. Reject ambiguous 'o'.
// See docs/internals/sql-unknown-boolean-context.md for the design.
