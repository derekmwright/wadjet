...
**Research:** `docs/_archive/research/2026-04-19-distribution-model-trino-spark.md`
...
- Research: `docs/_archive/research/2026-04-19-distribution-model-trino-spark.md`.
- Phase 1 spec: `docs/_archive/specs/2026-04-20-distribution-property-phase-1.md` (on `feat/distribution-property-phase-1`).
