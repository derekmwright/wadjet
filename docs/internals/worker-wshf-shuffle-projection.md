# Worker wshf shuffle projection

Source: internal/worker/wshf_shuffle_prune.go — func wshfShufflePruneKeep(schema []parquet.Column, declared, keys []string) []string {, moved 2026-09-11 (#1026)
